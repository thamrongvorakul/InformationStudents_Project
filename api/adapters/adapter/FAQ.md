...
```sh
$ npm install waterline-adapter
```

[![NPM](https://nodei.co/npm/waterline-adapter.png?downloads=true&stars=true)](https://nodei.co/npm/waterline-adapter/)
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8acf2fc2ca0aca8a3018e355ad776ed7 "githalytics.com")](http://githalytics.com/balderdashy/waterline-adapter/FAQ.md)
