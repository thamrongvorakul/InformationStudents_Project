...
angular.module('profileLec', ['ngFileUpload' , 'angularFileUpload' ,'ngCookies'])
.controller('profilelecController', ['$scope','$rootScope','Upload', '$http', 'FileUploader' , '$cookies',
  function ( $scope, $rootScope,Upload, $http , FileUploader  , $cookies )
  {
    ...
    .success(function(data, status, headers, config)
    {
        ...
        console.log($scope.name_send);
        //console.log(data);
          data2 = {
          'Name' : $scope.name_send
          };
